...
| ユースケース | 参照ファイル |
|-------------|-------------|
| サーバーサイドWebアプリ | [authorization-code.md](references/authorization-code.md) |
| SPA・モバイルアプリ | [pkce.md](references/pkce.md) |
| バックエンドサービス間通信 | [client-credentials.md](references/client-credentials.md) |
| スマートTV・CLI・IoT | [device-flow.md](references/device-flow.md) |

### 実装ガイド

| プラットフォーム | 参照ファイル |
|-----------------|-------------|
| React SPA | [spa-react.md](references/spa-react.md) |
| Node.js サーバー | [server-nodejs.md](references/server-nodejs.md) |
| モバイルアプリ | [mobile.md](references/mobile.md) |

### その他

| トピック | 参照ファイル |
|---------|-------------|
| セキュリティベストプラクティス | [best-practices.md](references/best-practices.md) |
| 共通パターン・例 | [common-patterns.md](references/common-patterns.md) |
